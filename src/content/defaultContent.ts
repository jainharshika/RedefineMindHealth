...
export const defaultContent: SiteContent = {
  profile: {
    ...
    tagline:
      "Counselling is not about fixing what is 'wrong' — it's about understanding what is happening within you and around you.",
  ...
  affiliations: [
    "Faculty, NMIMS University — Social & Educational Psychology",
  ...
  experience: [
    ...
    },
    {
      ...
      period: "Prior",
      description:
        "Community mental health support during my Master's at Dundee — supporting individuals experiencing emotional distress while also assisting with practical challenges such as housing, financial support, and daily functioning. Strengthened my understanding of person-centred, recovery-focused care.",
    },
    {
      id: "exp-apm",
  ...
  faqs: [
    {
      ...
      answer:
        "The first session is a relaxed conversation. We talk about what brings you in, what you're hoping for, and how we might work together. There's no pressure — it's a chance to see if it feels right for you.",
    },
    {
      id: "faq-format",
    ...
    },
    {
      ...
      answer:
        "It depends on you and what you're working through. Some people come for a few focused sessions; others prefer longer-term support. We revisit what's useful as we go — there's no fixed timeline.",
    },
    {
      id: "faq-fixing",
